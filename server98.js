...
app.get('/group-lessons.html', (req, res) => {
  return sendFirstExisting(res, ['group-lessons.html','group-lessons2.html','group-lessons2.fixed.html','group-lessons_fixed.html']);
});
...
function requireRole(roles = []) {
  return function (req, res, next) {
    try {
    // Any group member can view attendance; you can tighten this back to teacher-only if needed.
