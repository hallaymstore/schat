...
app.post('/api/lives/:id/status', requireRole(['teacher','admin']), async (req, res) => {
  try {
...
app.get('/api/tests/my-submissions', requireRole(['student','teacher','admin']), async (req, res) => {
  try {
...
app.delete('/api/tests/:id', requireRole(['teacher','admin']), async (req, res) => {
  try {
